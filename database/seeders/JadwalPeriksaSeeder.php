        ...
        foreach ($dokters as $dokter) {
            ...
            foreach ($doctorDays as $day) {
                ...
                JadwalPeriksa::create([
                    ...
                    'status'      => $firstSchedule ? true : false, // Only first schedule is active
                ]);

                $firstSchedule = false; // Mark subsequent schedules as inactive

                // Afternoon schedule (13:00 - 16:00) for doctors with even IDs
                if ($dokter->id % 2 === 0) {
                    JadwalPeriksa::create([
                        'id_dokter'   => $dokter->id,
                        'hari'        => $day,
                        ...
                        'status'      => false, // All afternoon schedules are inactive
                    ]);
                }
            }
        }
