            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('dokter.obat.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_obat" id="nama_obat" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('nama_obat') }}" required>
                    </div>

                    <div class="mb-4">
                        <label for="kemasan" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Kemasan</label>
                        <input type="text" name="kemasan" id="kemasan" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('kemasan') }}">
                    </div>

                    <div class="mb-4">
                        <label for="harga" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Harga (Rp)</label>
                        <input type="number" name="harga" id="harga" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('harga') }}" required>
                    </div>
